...
class ChatTab(BaseComponent):
    ...
    def create(self):
        ...
        self.character_combo = ttk.Combobox(char_frame, textvariable=self.character_var, state="readonly")
        ...
        # Chat display
        self.chat_text = scrolledtext.ScrolledText(chat_display_frame, wrap=tk.WORD, height=15)
        ...
        tts_button = ttk.Button(tts_frame, text="Generate TTS", command=self.generate_tts)
