...
class ChatLogDAO(BaseDAO):
    ...
    async def create_chat_log(self, character_id: int, user_message: str, 
                            character_response: str, emotion: Optional[str] = None,
                            metadata: Optional[Dict[str, Any]] = None) -> ChatLog:
        ...
        params = (character_id, user_message, character_response, emotion, metadata_json, now)
    ...
    async def get_chat_logs(self, character_id: Optional[int] = None, 
    ...
    async def get_recent_context(self, character_id: int, limit: int = 10) -> List[ChatLog]:
    ...
    async def delete_chat_logs(self, character_id: int, before_date: Optional[datetime] = None) -> int:
