...
from aichat.core.database import DatabaseManager, get_db
from aichat.core.event_system import EventSeverity, EventType, get_event_system
from aichat.logs.routes import router as logs_router
...
def create_app() -> FastAPI:
    ...
    async def startup_event():
        ...
        try:
            ...
            logger.warning(
                f"Database initialization skipped or failed during startup: {e}"
            )
    ...
    async def shutdown_event():
        ...
        try:
            # Emit shutdown event
            await event_system.emit(EventType.SERVICE_STOPPED, "Backend API stopped")
