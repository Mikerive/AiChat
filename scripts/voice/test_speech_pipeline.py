...
def run_tts_test(text: str, character: str = "assistant") -> str:
...
def test_audio_devices():
    ...
    try:
        ...
        assert False, f"Audio device test failed: {e}"

def run_chat_api_test(message: str, character: str = "assistant"):
    """Test chat API"""
...
def test_system_status():
    ...
    try:
        ...
        assert False, f"System status failed: {e}"
...
def run_comprehensive_test():
    ...
    welcome_audio = run_tts_test("Hello! Welcome to the VTuber voice interface test. I can hear and speak!")
    ...
    # 4. Chat API Test
    chat_response = run_chat_api_test("Hello, can you introduce yourself?")
    ...
    if chat_response:
        ...
        response_audio = run_tts_test(chat_response)
    ...
    if prompt_for_speech_test():
        ...
        # Ask user to speak
        instruction_audio = run_tts_test("Please speak now. I'm listening for 5 seconds. Tell me something interesting!")
        ...
        if user_input:
            # Send to chat
            ai_response = run_chat_api_test(user_input)
            
            if ai_response:
                # Convert to speech
                final_audio = run_tts_test(f"You said: {user_input}. Here's my response: {ai_response}")
